...
| 댓글/대댓글 | 게시물 댓글 작성, 답글(대댓글, **다단 중첩 허용**) 지원, 본인 댓글 삭제(물리 삭제가 아닌 삭제 상태 처리 + 삭제된 댓글은 "삭제된 댓글입니다." placeholder로 표시) — 댓글 수정은 미구현. 2026-08-07 정책 결정 및 구현·검증 완료(`docs/02-design/features/insight-comment.md` §⑩) |
